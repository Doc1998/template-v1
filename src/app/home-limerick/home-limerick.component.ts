...
@Component({
  selector: 'app-home-limerick',
  templateUrl: './home-limerick.component.html',
  styleUrls: ['./home-limerick.component.less']
})
export class HomeLimerickComponent implements OnInit{
